...
void assist_assist(void);

/**
 * assist_all - Displays all possible TesTed builtin TesTed commands.
 */
void assist_all(void)
{
...
msg = "Type 'assist' to see this list.\nType 'assist name' to find ";
write(STDOUT_FILENO, msg, _strlen(msg));
...
/**
 * assist_alias - Displays information on the TesTed builtin command 'alias'.
 */
void assist_alias(void)
{
...
/**
 * assist_cd - Displays information on the TesTed builtin command 'cd'.
 */
void assist_cd(void)
{
...
/**
 * assist_exit - Displays information on the TesTed builtin command 'exit'.
 */
void assist_exit(void)
{
...
/**
 * assist_assist - Displays information on the TesTed builtin command 'assist'.
 */
void assist_assist(void)
{
char *msg = "assist: assist\n\tSee all possible TesTed builtin commands.\n";
